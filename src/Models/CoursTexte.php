...
class CoursTexte extends Course implements ICreateCourse {
    ...
    public function create() {
        ...
        $stmt->execute([$this->title, $this->media_path, $this->category, $this->description, $this->price, $this->media_path, "text", $this->is_approved, $this->id_author]);
